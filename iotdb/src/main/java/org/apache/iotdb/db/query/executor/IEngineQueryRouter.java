...
public interface IEngineQueryRouter {
  ...
  QueryDataSet aggregate(List<Path> selectedSeries, List<String> aggres,
      ...
      throws QueryFilterOptimizationException, IOException, PathErrorException, ProcessorException, StorageGroupManagerException;
  ...
  QueryDataSet groupBy(List<Path> selectedSeries, List<String> aggres,
      ...
      PathErrorException, IOException, StorageGroupManagerException;
  /**
   * Execute fill query.
   *
  ...
  QueryDataSet fill(List<Path> fillPaths, long queryTime, Map<TSDataType, IFill> fillType,
      QueryContext context) throws PathErrorException, IOException, StorageGroupManagerException;
